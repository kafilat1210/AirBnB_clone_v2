...
'HBNB', 'C <text>', 'Python <text>', and a
HTML page with 'Number: n is even|odd'"""
...
def number_template(n):
    """This function returns a HTML page with 'Number: n' only if n is an
    integer"""
...
def number_odd_or_even(n):
    """This function returns a HTML page with 'Number: n is even|odd' only if
    n is an integer"""
    if n % 2 == 0:
